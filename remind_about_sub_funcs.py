...
async def remind_on_last_days_ofsub(users_with_almost_missed_sub, users_with_missed_sub):
...
async def remind_after_hour(unreminded_users):
...
async def remind_after_day(unreminded_users_after_day):
